...
public class NBASimGame extends AppCompatActivity {
    ...
    //Correlation of  player/position - Guard1 - Guard2 - Forward2 - Forward2 - Center
    String [] playerPlayerNames = {"None","None","None","None","None"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nba__sim__game);
    ...
    public void PickPlayer1(View v){
        ...
        if(position == "guard1"){
            ...
            playerPlayerNames[0] = text1.getText().toString();
    ...
    public void PickPlayer2(View v){
        ...
        if(position == "guard1"){
            ...
            playerPlayerNames[0] = text2.getText().toString();
            PlayerPickedNameChange();
        }
        if(position == "guard2"){
    ...
    public void PickPlayer3(View v){
        ...
        if(position == "guard1"){
            ...
            playerPlayerNames[0] = text3.getText().toString();
            PlayerPickedNameChange();
        }
        if(position == "guard2"){
    ...
    public void PickPlayer4(View v){
        ...
        if(position == "guard1"){
            ...
            playerPlayerNames[0] = text4.getText().toString();
            PlayerPickedNameChange();
        }
        if(position == "guard2"){
    ...
    public void PlayerPickedNameChange(){
        ...
        if(playerPlayerNames[0] !="None"){
            pp1.setText(playerPlayerNames[0]);
        }
        if(guard2 !="None"){
            pp2.setText(guard2);
        }
    ...
    public void CheckGameReady(){
        if((playerPlayerNames[0] != "None") && (guard2 != "None") && (forward1 != "None") && (forward2 != "None") && (center1 != "None")){
    ...
    public void setActionMessageSection( String name){
        ...
        message = name + " just made a field goal \n" + message;
    ...
    public void setScoreBoard(){
        ...
        p1p1.setText(playerPlayerNames[0]);
